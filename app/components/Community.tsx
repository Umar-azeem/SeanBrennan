    ...
    <section className="bg-[#f5f5f5] py-16 sm:py-24 lg:py-30 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        <div className="text-center lg:text-left">
          <p className="text-[#021A2B] uppercase tracking-[3px] sm:tracking-[6px] font-bold text-md sm:text-xl mb-6 sm:mb-8">
            Who we are
          </p>
          ...
          <p className="text-[15px] text-gray-600 leading-relaxed max-w-2xl mx-auto lg:mx-0 mb-10 sm:mb-14">
            ...
            you obtain the best loan possible. We represent a wide range of{" "}
            {`'`}A{`'`} rated lenders with first quality rates to private {`'`}
            hardship{`'`} lenders. We work with more than 100 investors. This
            allows us to get you the best rates on all types of loan programs
            including: 30yr mortgage, 20yr mortgage, 15yr mortgage, 10yr
            mortgage, 1yr ARMS, 3yr ARMS, 5yr ARMS, Conventional, Jumbo, Home
            Equity Lines, VA and Commercial. Whether your situation calls for
            Full Documents, No Documents, Non-Owner Occupied (Investor) or
            Multi-Family, we{`'`}ll fit your needs!
          </p>

          <Link href="/contact-us">
            {" "}
            <button className="bg-[#021A2B] w-full sm:w-auto flex items-center justify-center gap-3 text-white px-6 py-4 rounded-xl font-bold transition transform duration-300 hover:-translate-y-1">
              Contact
            </button>
          </Link>
