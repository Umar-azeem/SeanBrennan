...
---
This inquiry was sent from the Sean Brennan Mortgage website.`,
    );

    window.open(
      `mailto:sbrennan@nexamortgage.com?subject=${emailSubject}&body=${emailBody}`,
      "_blank",
    );
      ...
      <footer className="bg-white border-t border-gray-200 py-12 text-xs text-gray-500 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto space-y-4">
          <div className="flex flex-wrap items-start gap-x-6 gap-y-2 font-medium text-gray-700 text-sm">
            <span>NMLS ID: 168226</span>
            <span>NEXA Lending — NMLS ID: 1660690</span>
            <Link
              href="https://wa.me/12013173235"
              className="flex gap-2 w-full px-4"
            >
              <button className="">(201) 317-3235 </button>
            </Link>
          </div>
          ...
          <p className="leading-relaxed">
            <strong>Equal Housing Opportunity:</strong> Sean Brennan / NEXA
            Lending is an Equal Housing Opportunity lender. We are pledged to
            the letter and spirit of U.S. policy for the achievement of equal
            housing opportunity throughout the Nation.
          </p>
          <p className="text-gray-400 leading-relaxed">
            NMLS # 168226 — Licensed in NJ. NEXA Lending NMLS # 1660690.
          </p>
          <p className="text-gray-400 leading-relaxed">
            <a href="tel:+16023449333" className="hover:text-gray-600">
              (602) 344-9333
            </a>{" "}
            |{" "}
            <a
